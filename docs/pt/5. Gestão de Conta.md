...
# Mudar para um TORNEIO específico
# É necessário o ID do torneio obtido na plataforma
...
6. Para facilitar a gestão, você pode usar a enumeração `AccountType` localizada em `pyquotex.utils.account_type`.

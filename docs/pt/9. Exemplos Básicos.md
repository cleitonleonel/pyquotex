...
class TradingBot:
    def __init__(self, email, password):
        self.client = Quotex(
            email=email,
            password=password,
            host="qxbroker.com",  # Altere se houver bloqueio regional (ex: quotex.com, qxbroker.io)
        )
...
class SimpleBot:
    def __init__(self):
        self.client = Quotex(email="seu@email.com", password="sua_senha")
        self.running = False
...
async def monitor_mercado():
    client = Quotex(email="seu@email.com", password="sua_senha")

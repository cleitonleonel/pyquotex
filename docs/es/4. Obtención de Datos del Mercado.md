...
### Obtener Historial Profundo (Paralelo)
...
> [!CAUTION]
> **Aviso de Seguridad:** El uso de demasiados workers simultáneos (ej: > 10) puede resultar en el baneo de su cuenta
> por parte de Quotex debido al alto volumen de solicitudes al WebSocket. Recomendamos mantener entre **2 a 5 workers**

...
class TradingBot:
    def __init__(self, email, password):
        self.client = Quotex(
            email=email,
            password=password,
            host="qxbroker.com",  # Cambiar si hay bloqueo regional (ej: quotex.com, qxbroker.io)
        )
...
class SimpleBot:
    def __init__(self):
        self.client = Quotex(email="tu@email.com", password="tu_password")
        self.running = False
...
async def monitor_mercado():
    client = Quotex(email="tu@email.com", password="tu_password")

...
# Switch to a specific TOURNAMENT
# You need the tournament ID obtained from the platform
...
6. For easier management, you can use the `AccountType` enumeration located in `pyquotex.utils.account_type`.

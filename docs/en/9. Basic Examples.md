...
class TradingBot:
    def __init__(self, email, password):
        self.client = Quotex(
            email=email,
            password=password,
            host="qxbroker.com",  # Change if blocked in your region (e.g. quotex.com, qxbroker.io)
        )
...
class SimpleBot:
    def __init__(self):
        self.client = Quotex(email="your@email.com", password="your_password")
        self.running = False
...
async def monitor_market():
    client = Quotex(email="your@email.com", password="your_password")

...
def test_process_candles_v2_candles_after_header_skip():
    ...
    history = {"EURUSD": {"candles": historical}}
...
def test_process_candles_v2_malformed_candles():
    ...
    history = {"EURUSD": {"candles": [{"dummy": "header"}]}}
